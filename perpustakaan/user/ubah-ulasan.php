...
<body class="text-center">
  ...
  ?>
    <form class="form-signin" action="ubah-proses.php" method="post">
      ...
      <input type="hidden" value="<?php echo $ulasan['userid'] ?>" name="userid">
      <input type="hidden" value="<?php echo $ulasan['bukuid'] ?>" name="bukuid">
      ...
      <br>
      <a href="ulasan.php" class="btn btn-lg btn-primary">
        << Kembali</a>
