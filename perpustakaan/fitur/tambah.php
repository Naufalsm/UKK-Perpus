...
<body class="text-center">
  ...
  <form class="form-signin" action="tambah-proses.php" method="post" enctype="multipart/form-data">
    ...
    <select name="kategoriid" class="btn" style="color: #fff; background: #343a40;" required>
    ...
    <input type="text" id="penulis" class="form-control" placeholder="Penulis" name="penulis" required>
    <label for="inputEmail" class="sr-only">Penerbit</label>
    <input type="text" id="penerbit" class="form-control" placeholder="Penerbit" name="penerbit" required>
    <label for="inputEmail" class="sr-only">Tahun Terbit</label>
    <input type="number" id="tahunterbit" class="form-control" placeholder="Tahun Terbit" name="tahunterbit" required>
    <label for="inputEmail" class="sr-only">Stok</label>
    <input type="number" id="stok" class="form-control" placeholder="Stok Buku" name="stok" required>
