...
<body>
  <form action="index.php">
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Perpustakaan RPL</a>
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2" text-color >Dashboard | <small class="h5">
              <style>small {
        ...
        <h2 align="center">Perpustakaan RPL</h2>
        <br><br>
        <div class="row">
          ...
          <div class="col-xl-3 col-md-6">
            <div class="card bg-warning text-white mb-4">
              <div class="card-body">
                <?php
                echo mysqli_num_rows(mysqli_query($connect, "SELECT * FROM koleksipribadi LEFT JOIN user ON user.userid = koleksipribadi.userid WHERE koleksipribadi.userid='$userid'"));
                ?>
                Koleksi</div>
              <div class="card-footer d-flex align-items-center justify-content-between">
          ...
          <div class="col-xl-3 col-md-6">
            <div class="card bg-danger text-white mb-4">
              <div class="card-body">
                <?php
                echo mysqli_num_rows(mysqli_query($connect, "SELECT * FROM peminjaman LEFT JOIN user ON user.userid = peminjaman.userid WHERE peminjaman.userid='$userid'"));
                ?>
                Peminjaman</div>
              <div class="card-footer d-flex align-items-center justify-content-between">
