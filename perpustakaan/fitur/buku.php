...
<body>
  <form action="buku.php" method="get">
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      ...
      <input class="form-control form-control-dark w-100" type="text" placeholder="Search" aria-label="Search" name="cari" value="<?php if (isset($_GET['cari'])) {
                                                                                                                                    echo $_GET['cari'];
                                                                                                                                  } ?>">
    ...
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="sidebar-sticky pt-3">
          <ul class="nav flex-column">
            ...
            $qry = mysqli_query($connect, "SELECT * FROM user WHERE userid='$userid'");
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Buku | <small class="h5">
              <style>small {
              ...
              ?>
                <tr>
                  ...
                  <td><a class="btn btn-primary" href="edit.php?id=<?php echo $buku['bukuid']; ?>">Edit</a>
                    <a class="btn btn-danger" href="hapus.php?id=<?php echo $buku['bukuid']; ?>">Hapus</a>
                  </td>
                </tr>
              <?php
              }
