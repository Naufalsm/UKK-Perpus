    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Koleksi | <small class="h5">
              <style>small {
              ...
              ?>
                <tr>
                  ...
                  <td><a class="btn btn-success" href="lihat.php?id=<?php echo $favorite['bukuid']; ?>">Lihat</a>
                    <a class="btn btn-danger" href="hapus-favorite.php?userid=<?php echo $_SESSION['userid']; ?>&id=<?php echo $favorite['koleksiid']; ?>">Hapus</a>
