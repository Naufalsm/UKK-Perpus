...
<body>
  <div class="container">
    ...
    <form action="pengembalian-proses.php" method="post">
      ...
      $id = $_GET['id'];
      $query = mysqli_query($connect, "SELECT * FROM peminjaman LEFT JOIN buku ON buku.bukuid = peminjaman.bukuid WHERE peminjamanid=$id") or die(mysqli_error($connect));
      ...
      ?>
        ...
        <div class="main-user-info">
          ...
          <div class="user-input-box">
            ...
            <input type="date" id="tanggal" name="tglpengembalian" readonly />
            <input type="date" name="tglpeminjaman" value="<?php echo $kembali['tglpeminjaman'] ?>" hidden="hidden" readonly />
            ...
            <input type="hidden" name="bukuid" value="<?php echo $kembali['bukuid'] ?>" readonly />
            <input type="hidden" name="peminjamanid" value="<?php echo $kembali['peminjamanid'] ?>" readonly />
          </div>
        </div>
