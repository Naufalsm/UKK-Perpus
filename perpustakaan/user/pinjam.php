    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Peminjaman | <small class="h5">
              <style>small {
          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
              ...
              while ($pinjam = mysqli_fetch_array($result)) {
                $peminjamanid = $pinjam['peminjamanid'];
                $kodepinjam = $pinjam['kodepinjam'];
                $judul = $pinjam['judul'];
                $penulis = $pinjam['penulis'];
                $tglpeminjaman = $pinjam['tglpeminjaman'];
                $tglpengembalian = $pinjam['tglpengembalian'];
                $jumlah = $pinjam['jumlah'];
                $statuspeminjaman = $pinjam['statuspeminjaman'];
              ?>
                <tr>
                  <td><?php echo $no++ ?></td>
                  ...
                  <td><?php if ($statuspeminjaman == 'dikembalikan') {
